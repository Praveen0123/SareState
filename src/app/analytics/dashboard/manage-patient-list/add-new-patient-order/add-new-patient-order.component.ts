...
export class AddNewPatientOrderComponent implements OnInit {
  ...
  get uploadLOP() { return this.addBasicDetails.get('uploadLOP');}
  ...
  get testing() {return this.addAddressDetails.get('testing');}
  ...
  addNewPatientsForm() {
    this.addBasicDetails = this.fb.group({
      ...
      uploadLOP: new FormControl('',[Validators.required ,Validators.maxLength(50)]),
    })
  }
  ...
  addAddressForm() {
    this.addAddressDetails = this.fb.group({
      ...
      testing: new FormControl('',[Validators.required,Validators.maxLength(50),this.noWhiteSpaceValidator])
    })
  }
