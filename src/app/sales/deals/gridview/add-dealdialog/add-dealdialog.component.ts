...
@Component({
  selector: 'app-add-dealdialog',
  templateUrl: './add-dealdialog.component.html',
  styleUrls: ['./add-dealdialog.component.scss']
})
export class AddDealdialogComponent implements OnInit {

  addBasicDetails:FormGroup
  addDemographicDetails:FormGroup;
  constructor(public alertService:AlertService,public fb:FormBuilder ,public dialogRef:MatDialogRef<AddDealdialogComponent>,@Inject(MAT_DIALOG_DATA) public deal:any) {
