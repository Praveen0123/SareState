...
import  {AddDealdialogComponent} from './add-dealdialog/add-dealdialog.component';
...
export class GridviewComponent implements OnInit {
  ...
  public popoverleadMessage: string = 'Are you sure you want to convert this prospect to Deals ?'
  ...
  public openDealDialog(id) {
    let dialogRef = this.dialog.open(AddDealdialogComponent, {
      data: id,
      height: 'auto',
      width: '700px',
      autoFocus: false
