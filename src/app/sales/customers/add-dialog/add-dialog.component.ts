...
export class AddDialogComponent implements OnInit {
  ...
  constructor(public alertService:AlertService,public fb:FormBuilder ,public dialogRef:MatDialogRef<AddDialogComponent>,@Inject(MAT_DIALOG_DATA) public customer:any) {
