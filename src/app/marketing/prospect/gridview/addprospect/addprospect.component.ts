...
export class AddprospectComponent implements OnInit {
  ...
  constructor(public alertService:AlertService,public fb:FormBuilder ,public dialogRef:MatDialogRef<AddprospectComponent>,@Inject(MAT_DIALOG_DATA) public prospect:any) {
