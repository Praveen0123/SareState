...
import {AddprospectComponent } from './addprospect/addprospect.component';
...
export class GridviewComponent implements OnInit {
  ...
  public popoverleadMessage: string = 'Are you sure you want to convert this prospect to customer ?'
  ...
  public openprospectDialog(id) {
    let dialogRef = this.dialog.open(AddprospectComponent, {
      data: id,
      height: 'auto',
      width: '700px',
      autoFocus: false
